...
>
  ...
  <div className="relative z-10 px-6 max-w-4xl">
    ...
    <p className="text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed">
      Engaging blog posts, SEO content, and product descriptions that drive traffic and convert visitors. 
  ...
  <div className="mx-auto max-w-6xl px-4 py-28 grid md:grid-cols-2 gap-10 items-center">
    <div className="animate-fade-in">
      ...
      <h1 className="mt-2 text-4xl md:text-5xl font-extrabold leading-tight text-black dark:text-white">
        Engage Audiences with Powerful & Persuasive Copy
      </h1>
      
      <p className="mt-4 text-black dark:text-gray-300">
        Our expert copywriting services help businesses communicate clearly, 
        build trust, and drive action. From website content and blogs to product 
        descriptions and ad copy, we craft words that connect with your audience, 
        strengthen your brand voice, and inspire results.
      </p>
    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white dark:text-gray-400 mb-6 leading-relaxed">
                I create compelling content that engages your audience, improves your search rankings, 
                and drives meaningful results. From blog posts to product descriptions, every piece 
                is crafted to achieve your business goals.
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white dark:text-gray-300">SEO-optimized content for better rankings</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-600 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white  dark:text-gray-300">Engaging copy that converts visitors</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-600 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white dark:text-gray-300">Consistent brand voice and messaging</span>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Content Services</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Blog posts and articles</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Product descriptions</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Website copy</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Email marketing content</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Social media content</span>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div className="mx-auto max-w-7xl px-4">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-lg text-gray-600 max-w-2xl mx-auto">
        A clear and collaborative approach to deliver impactful, brand-aligned content
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Defining tone, messaging style, and content structure
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Crafting persuasive, engaging, and SEO-friendly copy
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Refinement</h3>
        <p className="text-gray-600">
          Editing, proofreading, and finalizing content for publishing
        </p>
      </div>
    </div>
  </div>
