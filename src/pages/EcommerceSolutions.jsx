...
>
  ...
  <div className="relative z-10 px-6 max-w-4xl">
    ...
    <p className="text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed">
      Online stores with secure checkout, product management, and seamless user experience. 
      Turn your products into profits with a professional e-commerce platform.
  ...
  <div className="mx-auto max-w-6xl px-4 py-28 grid md:grid-cols-2 gap-10 items-center">
    <div className="animate-fade-in">
      ...
      <h1 className="mt-2 text-4xl md:text-5xl font-extrabold leading-tight text-black dark:text-white">
        Drive Online Sales with Scalable E-Commerce Platforms
      </h1>
      
      <p className="mt-4 text-black dark:text-gray-300">
        We build secure, high-performance e-commerce solutions that help businesses grow 
        online. From sleek storefronts to fully integrated marketplaces, our platforms are 
        optimized for speed, scalability, and seamless user experience — ensuring your 
        customers enjoy effortless shopping across all devices.
      </p>
    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white  dark:text-gray-400 mb-6 leading-relaxed">
                I build comprehensive e-commerce solutions that handle everything from product 
                catalog management to secure payment processing. Your online store will be 
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white  dark:text-gray-300">Secure payment gateway integration</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white dark:text-gray-300">Inventory and order management</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white dark:text-gray-300">Mobile-optimized shopping experience</span>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">E-Commerce Features</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Product catalog with categories</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Shopping cart and wishlist</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Secure checkout process</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Order tracking and notifications</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Admin dashboard for management</span>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div className="mx-auto max-w-7xl px-4">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-lg text-gray-600 max-w-2xl mx-auto">
        A clear, step-by-step approach to build your online store and drive sales
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Analyzing your business goals, target customers, and product catalog
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Store Design</h3>
        <p className="text-gray-600">
          Creating a modern, user-friendly storefront that matches your brand
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Setting up products, payment gateways, and secure checkout systems
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Testing, going live, and providing continuous support for growth
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="mx-auto max-w-7xl px-4">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-lg text-white dark:text-gray-400 max-w-2xl mx-auto">
        End-to-end e-commerce services to help you launch, manage, and grow your online store
      </p>
    </div>
