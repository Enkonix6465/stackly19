            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white  dark:text-gray-300">{t('ecommerceSolutions.serviceOverview.features.securePayment')}</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white dark:text-gray-300">{t('ecommerceSolutions.serviceOverview.features.inventoryManagement')}</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white dark:text-gray-300">{t('ecommerceSolutions.serviceOverview.features.customizableDesign')}</span>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8">
                             <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('ecommerceSolutions.serviceOverview.ecommerceFeatures.title')}</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                    <span className="text-gray-600 dark:text-gray-400">{t('ecommerceSolutions.serviceOverview.ecommerceFeatures.productCatalog')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                    <span className="text-gray-600 dark:text-gray-400">{t('ecommerceSolutions.serviceOverview.ecommerceFeatures.shoppingCart')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                    <span className="text-gray-600 dark:text-gray-400">{t('ecommerceSolutions.serviceOverview.ecommerceFeatures.secureCheckout')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                    <span className="text-gray-600 dark:text-gray-400">{t('ecommerceSolutions.serviceOverview.ecommerceFeatures.orderTracking')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                    <span className="text-gray-600 dark:text-gray-400">{t('ecommerceSolutions.serviceOverview.ecommerceFeatures.adminDashboard')}</span>
                  </li>
              </ul>
            </div>
          </div>
  ...
  <div className="mx-auto max-w-7xl px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('ecommerceSolutions.process.steps.strategy.title')}</h3>
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('ecommerceSolutions.process.steps.storeDesign.title')}</h3>
        <p className="text-gray-600">
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('ecommerceSolutions.process.steps.development.title')}</h3>
        <p className="text-gray-600">
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('ecommerceSolutions.process.steps.launchSupport.title')}</h3>
        <p className="text-gray-600">
