...
>
  ...
  <div className="relative z-10 px-6 max-w-4xl">
    ...
    <p className="text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed">
      Logos, color palettes, and visual systems that make your brand unforgettable. 
      Create a lasting impression with professional branding that tells your story.
    </p>
  ...
  <div className="mx-auto max-w-6xl px-4 py-28 grid md:grid-cols-2 gap-10 items-center">
    <div className="animate-fade-in">
      ...
      <h1 className="mt-2 text-4xl md:text-5xl font-extrabold leading-tight text-black dark:text-white">
        Craft Memorable Brands with Creative & Strategic Design
      </h1>
      
      <p className="mt-4 text-black dark:text-gray-300">
        We help businesses stand out with impactful branding and visually stunning designs. 
        From logo creation and brand identity to complete design systems, our solutions 
        ensure your brand communicates trust, creativity, and consistency — leaving a 
    ...
    <div className="justify-self-center relative">
      ...
      <img
        ...
        className="h-56 w-56 md:h-80 md:w-85object-cover shadow-lg"
      />
    </div>
  </div>
</section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white dark:text-gray-400 mb-6 leading-relaxed">
                I create comprehensive branding solutions that capture your brand's essence and 
                communicate your values to your audience. From logos to complete brand guidelines, 
                every element is designed to build recognition and trust.
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white dark:text-gray-300">Unique and memorable logo design</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white dark:text-gray-300">Strategic color palette selection</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white dark:text-gray-300">Comprehensive brand guidelines</span>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Branding Deliverables</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Primary and secondary logos</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Color palette with hex codes</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Typography selection</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Brand style guide</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-500 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Social media templates</span>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div className="mx-auto max-w-7xl px-4">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-lg text-gray-600 max-w-2xl mx-auto">
        A creative and collaborative journey to shape your brand identity and visuals
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Brand Discovery</h3>
        <p className="text-gray-600">
          Understanding your vision, audience, and market positioning
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Creative Strategy</h3>
        <p className="text-gray-600">
          Defining brand tone, color palettes, and design direction
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Design Execution</h3>
        <p className="text-gray-600">
          Crafting logos, brand assets, and visual designs that stand out
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Delivering final assets and ensuring consistent brand application
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="mx-auto max-w-7xl px-4">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-lg text-white dark:text-gray-400 max-w-2xl mx-auto">
        Creative and strategic design services to shape a strong, memorable brand identity
      </p>
    </div>
