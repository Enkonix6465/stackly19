...
>
  ...
  <div className="relative z-10 px-6 max-w-4xl">
    ...
    <h1 className="mt-4 text-5xl md:text-6xl font-extrabold leading-tight text-white">
      we design and build clear, modern web experiences
    </h1>
...
<section id="mission" className="relative border-t border-black/10 bg-gradient-to-b from-white to-indigo-50">
  <div className="mx-auto max-w-6xl px-4 py-24">
    <h2 className="text-3xl font-extrabold">Mission & Values</h2>
    <p className="text-black/70 mt-1">What drives our freelancing community</p>

    <div className="mt-12 grid md:grid-cols-3 gap-8">
      {[{
        t: 'Trust', 
        d: 'Building reliable connections between clients and freelancers with secure payments and verified profiles.', 
        ...
        t: 'Quality', 
        d: 'Delivering top-notch work through skilled professionals who take pride in their craft.', 
        ...
        t: 'Collaboration', 
        d: 'Encouraging open communication, feedback, and teamwork to achieve the best results.', 
  ...
  <div className="mx-auto max-w-6xl px-4 py-24 grid md:grid-cols-2 gap-10 items-center">
    ...
    <div className="order-2 md:order-1">
      ...
      <p className="text-white/70 mt-3">
        We are a freelancing platform that connects talented professionals with businesses and entrepreneurs 
        worldwide. From design to development, writing to marketing — our mission is to make hiring and 
        working with freelancers simple, transparent, and effective.
      </p>
      <p className="text-white/70 mt-3">
        Whether you’re a client searching for the right expertise or a freelancer looking for your next 
        opportunity, we provide the tools, trust, and flexibility to help you succeed.
      </p>
...
<section id="journey" className="border-t border-black/10">
  <div className="mx-auto max-w-6xl px-4 py-24">
    ...
    <p className="text-black/70 mt-1">From a small idea to a thriving freelancing community</p>
    ...
    <div className="mt-10 grid md:grid-cols-2 gap-8 items-stretch">
      ...
      <div className="flex flex-col justify-between rounded-xl border border-black/10 p-8 bg-gradient-to-br from-white to-indigo-50 shadow-lg animate-fade-in">
        <div className="space-y-8">
          {[
            { y: '2018', h: 'The Idea', d: 'Started as a simple vision to connect freelancers with local clients.' },
            { y: '2020', h: 'Expanding Globally', d: 'Opened doors for international talent and businesses to collaborate.' },
            { y: '2022', h: 'Building Trust', d: 'Launched secure payments, verification, and reviews for reliability.' },
            { y: '2024', h: 'Scaling the Platform', d: 'Empowering thousands of freelancers and companies to work together seamlessly.' }
          ].map((it, i) => (
      ...
      <div className="flex flex-col justify-between rounded-xl border border-black/10 p-8 bg-gradient-to-br from-indigo-50 to-white shadow-lg animate-fade-in">
        <div>
          ...
          <ul className="mt-4 space-y-3 text-black/80 text-sm">
            <li className="flex items-start gap-2"><span className="text-indigo-500">▸</span> Access to a global pool of trusted freelancers</li>
            <li className="flex items-start gap-2"><span className="text-indigo-500">▸</span> Hassle-free and secure payments</li>
            <li className="flex items-start gap-2"><span className="text-indigo-500">▸</span> Verified talent with proven skills</li>
            <li className="flex items-start gap-2"><span className="text-indigo-500">▸</span> Collaboration tools for async-friendly workflows</li>
            <li className="flex items-start gap-2"><span className="text-indigo-500">▸</span> Scalable support for both small tasks and large projects</li>
            <li className="flex items-start gap-2"><span className="text-indigo-500">▸</span> Dedicated 24/7 platform support</li>
            <li className="flex items-start gap-2"><span className="text-indigo-500">▸</span> Long-term partnerships for sustainable growth</li>
          </ul>
        </div>
...
<section id="engagement" className="border-t border-black/10 relative overflow-hidden">
  ...
  <div className="mx-auto max-w-6xl px-4 py-24 relative">
    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
      <div>
        <h2 className="text-3xl font-extrabold">Ways You Can Hire Me</h2>
        <p className="text-black/70 mt-1">Choose a freelancing model that fits your needs</p>
      </div>
    ...
    <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="group relative rounded-2xl border border-black/10 bg-white p-6 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/20 animate-slide-up">
        <div className="absolute right-4 top-4 rounded-full border border-black/10 bg-white/70 backdrop-blur px-2 py-0.5 text-xs font-medium">Best for Startups</div>
        ...
        <h3 className="mt-4 text-xl font-bold">Project-Based</h3>
        <p className="mt-2 text-black/70">Hire me for complete end-to-end projects with a clear timeline.</p>
        <ul className="mt-4 space-y-2 text-sm text-black/80">
          <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-500" /> One-time projects</li>
          <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-500" /> Transparent pricing</li>
        </ul>
      ...
      <div className="group relative rounded-2xl border border-black/10 bg-white p-6 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/20 animate-slide-up [animation-delay:80ms]">
        <div className="absolute right-4 top-4 rounded-full border border-black/10 bg-white/70 backdrop-blur px-2 py-0.5 text-xs font-medium">Quick & Flexible</div>
        <div className="h-11 w-11 rounded-md bg-indigo-500 text-black grid place-items-center">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-6 w-6">
        ...
        <h3 className="mt-4 text-xl font-bold">Hourly Work</h3>
        <p className="mt-2 text-black/70">Pay only for the hours you need—perfect for bug fixes, audits, or small tasks.</p>
        <ul className="mt-4 space-y-2 text-sm text-black/80">
          <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-500" /> No long-term contracts</li>
          <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-500" /> On-demand expertise</li>
        </ul>
        <button className="mt-5 inline-flex items-center gap-2 text-indigo-600 font-semibold">
          Hire by Hour
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4">
      ...
      <div className="group relative rounded-2xl border border-black/10 bg-white p-6 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/20 animate-slide-up [animation-delay:160ms]">
        <div className="absolute right-4 top-4 rounded-full border border-black/10 bg-white/70 backdrop-blur px-2 py-0.5 text-xs font-medium">Most Popular</div>
        <div className="h-11 w-11 rounded-md bg-indigo-500 text-black grid place-items-center">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-6 w-6">
        ...
        <h3 className="mt-4 text-xl font-bold">Monthly Retainer</h3>
        <p className="mt-2 text-black/70">Get a set number of hours every month for ongoing work and priority support.</p>
        <ul className="mt-4 space-y-2 text-sm text-black/80">
          <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-500" /> Guaranteed availability</li>
          <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-500" /> Lower hourly rates</li>
        </ul>
        <button className="mt-5 inline-flex items-center gap-2 text-indigo-600 font-semibold">
          Book Retainer
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4">
      ...
      <div className="group relative rounded-2xl border border-black/10 bg-white p-6 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/20 animate-slide-up [animation-delay:240ms]">
        <div className="absolute right-4 top-4 rounded-full border border-black/10 bg-white/70 backdrop-blur px-2 py-0.5 text-xs font-medium">Fast Delivery</div>
        <div className="h-11 w-11 rounded-md bg-indigo-500 text-black grid place-items-center">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-6 w-6">
            <path d="M5 12h14" />
        ...
        <h3 className="mt-4 text-xl font-bold">Weekly Sprints</h3>
        <p className="mt-2 text-black/70">Work in 1–2 week cycles to rapidly test ideas and deliver results quickly.</p>
        <ul className="mt-4 space-y-2 text-sm text-black/80">
          <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-500" /> Fast iterations</li>
          <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-500" /> Demo-based progress</li>
        </ul>
        <button className="mt-5 inline-flex items-center gap-2 text-indigo-600 font-semibold">
          Try a Sprint
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4">
...
<section id="faq" className="border-t border-black/10 bg-black text-white">
  <div className="mx-auto max-w-6xl px-4 py-24">
    <div className="mb-10">
      ...
      <p className="text-white/70 mt-1">Answers to questions clients often ask</p>
    </div>
    <div className="grid md:grid-cols-2 gap-6">
      {[
        { q: 'What types of projects do you take on?', a: 'I specialize in freelance front-end development, UI/UX design, and responsive websites for startups, entrepreneurs, and small businesses.' },
        { q: 'How does the payment process work?', a: 'Payments are milestone-based. You only release funds after each phase is delivered and approved, ensuring full transparency.' },
        { q: 'Can you handle urgent projects?', a: 'Yes, I can take on fast-track projects depending on availability. Timelines are always discussed upfront to avoid surprises.' },
        { q: 'How do we communicate?', a: 'I’m flexible with tools—Zoom, Google Meet, Slack, or email. I provide regular async updates and weekly check-ins.' },
        { q: 'Do you provide revisions?', a: 'Absolutely. Each project includes a set number of revisions to make sure you’re 100% satisfied with the final result.' },
        { q: 'What if I need ongoing support?', a: 'I offer retainer packages and long-term collaboration for updates, maintenance, and scaling as your business grows.' }
      ].map(item => (
        <details key={item.q} className="rounded-xl border border-white/15 bg-white/5 p-5 open:animate-fade-in">
