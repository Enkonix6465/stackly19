...
export default function Home() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Proven strategies to build trust and grow your income.",
    ...
    {
      title: "Top Skills in Demand 2025",
      excerpt: "Discover what clients are hiring for the most this year.",
      image: "/images/skills-demand.jpg",
    },
    {
      title: "Freelancer Success Stories",
      excerpt: "Inspiring journeys of freelancers who scaled their careers.",
      image: "/images/success-stories.jpg",
    },
    {
      title: "Managing Client Expectations",
      excerpt: "Tips to communicate clearly and deliver exceptional results.",
...
>
  ...
  <div className="relative z-10 px-6 max-w-4xl">
    ...
    <p className="mt-6 text-xl text-white/80 max-w-3xl mx-auto">
      Connect with top talent, get work done faster, and grow your business seamlessly.
    </p>
...
<section id="hero" className="relative overflow-hidden border-t border-black/10 dark:border-gray-700">
  <div className="mx-auto max-w-6xl px-4 py-28 grid md:grid-cols-2 gap-10 items-center">
    <div className="animate-fade-in">
      <p className="text-sm tracking-widest text-black dark:text-white">FREELANCING MADE SIMPLE</p>
      
      <h1 className="mt-2 text-4xl md:text-5xl font-extrabold leading-tight text-black dark:text-white">
        Connect with Clients & Grow Your Freelance Career
      </h1>
      
      <p className="mt-4 text-black dark:text-gray-300">
        A platform built for freelancers to showcase skills, land high-paying projects, 
        and collaborate with clients worldwide.
      </p>
 ...
 <section id="about" className="border-t border-black/10 dark:border-gray-700 bg-black text-white">
  <div className="mx-auto max-w-6xl px-4 py-24 grid md:grid-cols-3 gap-10">
    ...
    <div className="md:col-span-1">
      ...
      <p className="mt-2 text-white/70">Empowering businesses & freelancers worldwide</p>
    </div>

    {/* Content */}
    <div className="md:col-span-2">
      <p className="text-justify leading-relaxed animate-slide-up">
        We are a global freelancing platform built to connect businesses with skilled professionals across every industry. 
        Our mission is to simplify collaboration by offering secure payments, milestone protection, and real-time communication. 
        With experts in design, development, writing, marketing, and more, we make it easy to find the right talent for every project. 
        By combining transparency, accessibility, and innovation, we ensure that both clients and freelancers can thrive. 
        Together, we are shaping the future of work through trust, opportunity, and growth.
      </p>
    </div>
  </div>
</section>
 ...
 <section id="services" className="border-t border-black/10 dark:border-gray-700">
  <div className="mx-auto max-w-6xl px-4 py-24">
         <h2 className="text-3xl font-extrabold text-black dark:text-white">Our Services</h2>
     <p className="text-black/70 dark:text-gray-300 mt-1">Discover what freelancers can do for you</p>

    <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {[
        { t: 'Web Development', d: 'Custom websites, apps, and responsive solutions.' },
        { t: 'Graphic & UI Design', d: 'Logos, branding, and modern user experiences.' },
        { t: 'Content Writing', d: 'Blogs, articles, SEO-friendly copy, and more.' },
        { t: 'Digital Marketing', d: 'SEO, social media, and performance campaigns.' },
        { t: 'Video & Animation', d: 'Explainers, motion graphics, and product videos.' },
        { t: 'Business Support', d: 'Virtual assistants, project management, and admin help.' },
      ].map((card, idx) => (
                 <div
           key={card.t}
 ...
 <section id="blog" className="border-t border-black/10 dark:border-gray-700 bg-black">
  <div className="mx-auto max-w-6xl px-4 py-24 text-white">
    <div className="flex items-end justify-between">
      <div>
        <h2 className="text-3xl font-extrabold">Latest Blog</h2>
        <p className="text-white/70 mt-1">Insights, tips, and freelancing stories</p>
      </div>
    ...
    <div className="mt-8 text-center md:hidden">
      ...
      >
        {showAllBlogs ? 'Show Less' : 'See All Posts'}
      </button>
    </div>
  </div>
</section>
  ...
  <div className="mx-auto max-w-6xl px-4 py-24 grid md:grid-cols-2 gap-10 items-center">
    ...
    <div>
      ...
      <p className="text-white/70 mt-2">
        Whether it’s a new product idea or scaling your business, we’re here to help you
        turn vision into reality with smart, scalable solutions.
      </p>
      ...
      <ul className="mt-6 space-y-3 text-white/80">
        ...
        <li className="flex items-center gap-2">
          <span className="text-indigo-400 text-lg">✔</span>
          Future-ready & scalable technology
        </li>
        <li className="flex items-center gap-2">
          <span className="text-indigo-400 text-lg">✔</span>
