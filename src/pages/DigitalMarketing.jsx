...
>
  ...
  <div className="relative z-10 px-6 max-w-4xl">
    ...
    <p className="text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed">
      Social media campaigns, ads, and email funnels that grow your audience and drive conversions. 
    </p>
  ...
  <div className="mx-auto max-w-6xl px-4 py-28 grid md:grid-cols-2 gap-10 items-center">
    <div className="animate-fade-in">
      ...
      <p className="mt-4 text-black dark:text-gray-300">
        We help brands boost their online presence with customized digital marketing 
        campaigns. From SEO and content marketing to social media and paid ads, our 
        strategies are designed to attract, engage, and convert your audience — delivering 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white dark:text-gray-400 mb-6 leading-relaxed">
                I develop comprehensive digital marketing strategies that increase your online presence, 
                engage your target audience, and drive measurable business growth. From social media 
                management to paid advertising, every campaign is optimized for results.
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white dark:text-gray-300">Data-driven marketing strategies</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-600 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white dark:text-gray-300">Multi-channel campaign management</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-indigo-600 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white dark:text-gray-300">ROI-focused campaign optimization</span>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Marketing Services</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Social media management</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">PPC and Google Ads</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                ...
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Content marketing strategy</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                  <span className="text-gray-600 dark:text-gray-400">Analytics and reporting</span>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div className="mx-auto max-w-7xl px-4">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-lg text-gray-600 max-w-2xl mx-auto">
        A proven step-by-step approach to help your brand grow and achieve measurable results
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Analyzing your market, audience, and competitors to craft a winning strategy
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Producing engaging content, ads, and creatives that attract and convert
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Campaign Execution</h3>
        <p className="text-gray-600">
          Running data-driven ads and campaigns across the right digital channels
        </p>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Tracking results, optimizing performance, and scaling your campaigns for growth
        </p>
      </div>
    </div>
  </div>
